const { Provider, Type, klasaUtil: { isObject, makeObject, chunk }, config } = require("../index");
...
module.exports = class extends Provider {
    ...
    constructor(...args) {
        super(...args);
        if (this.client.options.providers.default !== "rethinkdb") return;
        this.db = rethink({
            db: "botcord",
            servers: [{ host: config.database.host, port: config.database.port }],
            slient: true,
            log: this.client.console.log
        });
    }
